...
import 'job_listing_preview_page.dart';
...
class _JobListingEditPageState extends State<JobListingEditPage> {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  //  4. APPLICATION DETAILS — UPDATED: date cross-validation
  // ═══════════════════════════════════════════════════════════════════════════
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              // ── Start Date — no firstDate restriction (can pick any date) ──
              Expanded(
              ...
              SizedBox(width: 16.w),
              // ── End Date — firstDate is _hiringStart so picker blocks earlier dates ──
              Expanded(
                child: _dateFieldCalendar(
