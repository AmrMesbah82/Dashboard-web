...
import 'job_listing_main_page.dart';
...
class _TableSettingDialogContentState
  ...
  void initState() {
    ...
    print(
      '🟢 [TableSetting] Dialog initState — keys: ${_tempVisibility.keys.length}',
    );
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        print(
                          '🟢 [TableSetting] Save pressed — visible: ${_tempVisibility.entries.where((e) => e.value).length}',
                        );
...
class _ApplicantDetailsTabState extends State<_ApplicantDetailsTab> {
  ...
  Future<void> _openCalendarPicker() async {
    print('🟡 [Tab3] _openCalendarPicker tapped');
    ...
    if (result != null && result.isNotEmpty && result.first != null && mounted) {
      print('🟢 [Tab3] Calendar picked: ${result.first}');
      setState(() {
